...
# multi-arch manifests (e.g. nrel/openstudio:3.11.0-amd64 + -arm64 -> :3.11.0).
# Requires docker buildx (bundled with Docker CLI 19.03+, enabled via
# docker/setup-buildx-action in CI).
#
