...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.0.0-rc3%2B949b904134-Linux.deb
...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/v3.0.0-rc3/$OPENSTUDIO_DOWNLOAD_FILENAME \
