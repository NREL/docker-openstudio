...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.0.1-rc2%2B7de76c9b4e-Linux.deb
...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/3.0.1-rc2/$OPENSTUDIO_DOWNLOAD_FILENAME \
