...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/develop3/OpenStudio3-prerelease-rc1.d3ec7ff9b5-2.8.1-Linux.deb/$OPENSTUDIO_DOWNLOAD_FILENAME \
