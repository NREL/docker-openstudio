...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.1.0-rc1%2B062e7a8260-Linux.deb
...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/3.1.0-rc1/$OPENSTUDIO_DOWNLOAD_FILENAME \
