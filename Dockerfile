...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.0.0-rc2%2B5c01d5ec3c-Linux.deb
...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/v3.0.0-rc2/$OPENSTUDIO_DOWNLOAD_FILENAME \
