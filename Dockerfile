...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.2.0-alpha%2B3674123721-Ubuntu-18.04.deb
...
RUN apt-get update && apt-get install -y \
        ...
        locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/incremental/develop/4172/$OPENSTUDIO_DOWNLOAD_FILENAME \
