...
ENV OPENSTUDIO_DOWNLOAD_FILENAME=OpenStudio-3.0.1%2B09b7c8a554-Linux.deb
...
RUN apt-get update && apt-get install -y \
	    ...
	    locales \
        sudo \
    && export OPENSTUDIO_DOWNLOAD_URL=https://openstudio-ci-builds.s3-us-west-2.amazonaws.com/3.0.1/$OPENSTUDIO_DOWNLOAD_FILENAME \
